...
// Temperature and humidity sensor endpoints are disabled to avoid I2C driver conflicts
...
extern "C" void app_main()
{
    ...
    // Print onboarding codes (QR/Base38 and manual code) to serial at boot
